...
exports.NextCodeProvider = void 0;
const vscode = __importStar(require("vscode"));
const axios_1 = __importDefault(require("axios"));
const settings_1 = require("./settings");
const extension_1 = require("./extension");
class NextCodeProvider {
    constructor() {
        this.isEnabled = true;
        ...
        this.settingsManager = new settings_1.SettingsManager();
    }
        ...
        return new Promise((resolve) => {
            this.debounceTimer = setTimeout(async () => {
                ...
                try {
                    ...
                    const completion = await this.getCompletion(contextInfo.contextText, document.languageId, controller.signal);
                    ...
                    // 更新使用统计
                    extension_1.statusBarManager.incrementUsage(completion.length / 4);
    ...
    async getCompletion(prompt, languageId, signal) {
        const config = this.settingsManager.getConfig();
...
- Keep completions short and focused (1-3 lines preferred)`;
        ...
        try {
            ...
            const response = await axios_1.default.post(this.settingsManager.getApiEndpoint(), requestBody, {
...
exports.NextCodeProvider = NextCodeProvider;
